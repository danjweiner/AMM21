...
parser.add_argument("--snp_ref_bim", help=".bim file up to the chr integer", required=False)
parser.add_argument("--snp_loc_col", help="SNP file, SNP column location index", required=False, type = int)
parser.add_argument("--snp_rsid_col", help="SNP file, SNP column location index", required=False, type = int)
parser.add_argument("--genes_ref", help="Gene reference file, up to the chr integer", required=False)
parser.add_argument("--genes_loc_col", help="Gene reference file, gene column location index", required=False, type = int)
parser.add_argument("--genes_ensg_col", help="Gene reference file, gene ensg gene ID location index", required=False, type = int)
parser.add_argument("--kn_k", help="Gene size of kn matrix (to kth closest gene)", required=False, type = int)
parser.add_argument('--m', help="module number", required=True, type = int)
parser.add_argument('--out', help="out directory path", required=True)
parser.add_argument('--kn_in_dir', help="The root directory where the kn matrix is located", required=False)
...
parser.add_argument('--lds_ref_binary', help="Plink binary genotype file for ld score reference, up to the chr integer", required=False)
parser.add_argument('--lds_snps_out', help="List of SNPs to restrict LD score output to, ends .snps", required=False)
parser.add_argument('--pk_vector', help="pk vector, one entry per bin, a list of floats (no comma separation)", required=False, type=float, nargs='+')
parser.add_argument('--pk_size', help="size of each pk bin, integers, (no comma separation)", required=False, type=int, nargs='+')
parser.add_argument('--ss_list', help="Summary statistics for analysis, in format [trait_name]:[trait path]", required=False)
...
parser.add_argument('--freq_file', help="Allele frequencies, available from LD score repository, ending before chr integer", required=False)
...
parser.add_argument("--iterator", help="Iterator for module; see wiki for details", required=False, type = int)
